...
export class Backend implements backendInterface {
    ...
    async getCallerNickname(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerNickname();
    ...
    async getLastWeeklyReset(): Promise<Time | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastWeeklyReset();
    ...
    async getWeeklyTopScores(): Promise<Array<LeaderboardEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWeeklyTopScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetWeeklyScores(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetWeeklyScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveNickname(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveNickname(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitWeeklyScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitWeeklyScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async validateNickname(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.validateNickname(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
